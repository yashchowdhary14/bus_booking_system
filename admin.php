...
<html>
    ...
    <style>
        body {
    background-image: url(https://wallpapers.com/images/hd/bus-pictures-tcw9a0iu0syn4x7t.jpg); 
    height: 96vh;
    background-position: center;
    background-repeat: no-repeat;
    background-size: cover;
}
.card{background-color: khaki;}
    </style>
	<body id='login-body' class="bg-light">
        <!-- <img src="../assets/img/home-img" alt="bus image"> -->
